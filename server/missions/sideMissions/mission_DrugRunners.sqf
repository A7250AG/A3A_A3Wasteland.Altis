...
// ******************************************************************************************
//	@file Name: mission_DrugRunners.sqf
//	@file Author: JoSchaap, AgentRev, LouD

if (!isServer) exitwith {};
#include "sideMissionDefines.sqf";

private ["_convoyVeh", "_veh1", "_createVehicle", "_vehicles", "_leader", "_waypoint", "_vehicleName", "_numWaypoints", "_drop_item", "_drugpile"];
...
_setupObjects =
{
	...
	_missionHintText = format ["Drug runners have been spotted driving a <t color='%2'>%1</t>. Stop them quickly and retrieve their drugs!", _vehicleName, sideMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "You have stopped the drug runners. The drugs are yours to take!";
};
